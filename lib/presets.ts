...
export const FALLBACK_CHANNELS: ChannelPreset[] = [
  ...
  { slug: "club", name: "Club (direct)", hasDistributor: false, distributorMarkupPct: null, retailerMarginPct: 12.5, sampleSize: 10, note: "Direct — no distributor layer" },
...
export const FALLBACK_DISTRIBUTORS: DistributorPreset[] = [
  ...
  { slug: "direct", name: "Direct (no distributor)", hasDistributor: false, distributorMarkupPct: null, sampleSize: 22 },
  { slug: "dsd", name: "DSD (direct store delivery)", hasDistributor: true, distributorMarkupPct: 17.5, sampleSize: 8 },
];
